...
namespace dpc
{
    ...
    {
        public string defaultpath = "D:\\wfa";
        public string path = "D:\\wfa";
        ...
        public Form1()
        {
            ...
            if (!File.Exists(defaultpath + "\\" + "password.txt"))
            {
                StreamWriter MyWriter = new StreamWriter(defaultpath + "\\" + "password.txt");
                MyWriter.Write("");
                MyWriter.Flush();
                MyWriter.Close();
            }
